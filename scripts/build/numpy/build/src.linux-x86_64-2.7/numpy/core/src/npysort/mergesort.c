...
mergesort_bool(npy_bool *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_bool *) malloc((num/2) * sizeof(npy_bool));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_byte(npy_byte *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_byte *) malloc((num/2) * sizeof(npy_byte));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_ubyte(npy_ubyte *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_ubyte *) malloc((num/2) * sizeof(npy_ubyte));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_short(npy_short *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_short *) malloc((num/2) * sizeof(npy_short));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_ushort(npy_ushort *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_ushort *) malloc((num/2) * sizeof(npy_ushort));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_int(npy_int *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_int *) malloc((num/2) * sizeof(npy_int));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_uint(npy_uint *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_uint *) malloc((num/2) * sizeof(npy_uint));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_long(npy_long *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_long *) malloc((num/2) * sizeof(npy_long));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_ulong(npy_ulong *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_ulong *) malloc((num/2) * sizeof(npy_ulong));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_longlong(npy_longlong *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_longlong *) malloc((num/2) * sizeof(npy_longlong));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_ulonglong(npy_ulonglong *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_ulonglong *) malloc((num/2) * sizeof(npy_ulonglong));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_float(npy_float *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_float *) malloc((num/2) * sizeof(npy_float));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_double(npy_double *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_double *) malloc((num/2) * sizeof(npy_double));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_longdouble(npy_longdouble *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_longdouble *) malloc((num/2) * sizeof(npy_longdouble));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_cfloat(npy_cfloat *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_cfloat *) malloc((num/2) * sizeof(npy_cfloat));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_cdouble(npy_cdouble *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_cdouble *) malloc((num/2) * sizeof(npy_cdouble));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_clongdouble(npy_clongdouble *start, npy_intp num, void *NOT_USED)
{
    ...
    pl = start;
    pr = pl + num;
    pw = (npy_clongdouble *) malloc((num/2) * sizeof(npy_clongdouble));
    if (pw == NULL) {
        return -NPY_ENOMEM;
    }
...
mergesort_string(npy_char *start, npy_intp num, PyArrayObject *arr)
{
    ...
    pl = start;
    pr = pl + num*len;
    pw = (npy_char *) malloc((num/2) * elsize);
    if (pw == NULL) {
        err = -NPY_ENOMEM;
        goto fail_0;
    }
    vp = (npy_char *) malloc(elsize);
    if (vp == NULL) {
        err = -NPY_ENOMEM;
        goto fail_1;
    }
...
mergesort_unicode(npy_ucs4 *start, npy_intp num, PyArrayObject *arr)
{
    ...
    pl = start;
    pr = pl + num*len;
    pw = (npy_ucs4 *) malloc((num/2) * elsize);
    if (pw == NULL) {
        err = -NPY_ENOMEM;
        goto fail_0;
    }
    vp = (npy_ucs4 *) malloc(elsize);
    if (vp == NULL) {
        err = -NPY_ENOMEM;
        goto fail_1;
    }
