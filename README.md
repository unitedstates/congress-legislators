...
* terms (one entry for each election)
	...
	* how: How the term came to be. This field is generally not present. The field is set to "appointment" for [senators appointed to fill a vacancy](https://www.senate.gov/senators/AppointedSenators.htm). Senators and representatives elected by special election are not yet marked in the data.
